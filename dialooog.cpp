    ...
    ui(new Ui::dialooog)
{
    ...
    QPixmap pixmapUpdate("/home/ubuntu/RosUiSDK/setting/update.png");
    QIcon buttonIconUpdate(pixmapUpdate);
    ui->btn_update->setIcon(buttonIconUpdate);
    ui->btn_update->setIconSize(QSize(150,150));

    QPixmap pixmapSkype("/home/ubuntu/RosUiSDK/setting/skype.png");
...
{
    QPixmap pixmapUpdate("/home/ubuntu/RosUiSDK/setting/update_2.png");
    QIcon buttonIconUpdate(pixmapUpdate);
    ui->btn_update->setIcon(buttonIconUpdate);
    ui->btn_update->setIconSize(QSize(150,150));
