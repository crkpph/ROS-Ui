    ...
    ui(new Ui::dialooog)
{
    ...
    QPixmap pixmapUpdate("/home/aleleykaye/RosUiSDK/setting/update.png");
    QIcon buttonIconUpdate(pixmapUpdate);
    ui->btn_update->setIcon(buttonIconUpdate);
    ui->btn_update->setIconSize(QSize(150,150));

    QPixmap pixmapSkype("/home/aleleykaye/RosUiSDK/setting/skype.png");
...
{
    QPixmap pixmapUpdate("/home/aleleykaye/RosUiSDK/setting/update_2.png");
    QIcon buttonIconUpdate(pixmapUpdate);
    ui->btn_update->setIcon(buttonIconUpdate);
    ui->btn_update->setIconSize(QSize(150,150));
